...
#define DFG_TEMP_MACRO_DEFINE_STRCAT(PARAMTYPE, STR) \
    ...
    DFG_TEMP_MACRO_DEFINE_STRCAT(DFG_CLASS_NAME(StringViewAscii), SzPtrAscii(""));
    DFG_TEMP_MACRO_DEFINE_STRCAT(DFG_CLASS_NAME(StringViewLatin1), SzPtrLatin1(""));
    DFG_TEMP_MACRO_DEFINE_STRCAT(DFG_CLASS_NAME(StringViewUtf8), SzPtrUtf8(""));
