...
public:
    ...
    */
    ...
    template <class CellHandler, class CellDataT>
    static void readFromFile(const DFG_CLASS_NAME(ReadOnlyParamStrC)& sPath, CellDataT& cd, CellHandler&& cellHandler, const TextEncoding encoding = encodingUnknown)
    {
