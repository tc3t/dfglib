...
#define DFG_COMPILER_NAME_SIMPLE_VC2019_8        "MSVC_2019.8"
#define DFG_COMPILER_NAME_SIMPLE_VC2019_9        "MSVC_2019.9"
...
#define DFG_COMPILER_NAME_SIMPLE_UNKNOWN         "UNKNOWN_COMPILER"
    ...
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2017_5
    ...
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2017_7
#elif DFG_MSVC_VER == DFG_MSVC_VER_2017_8
	#define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2017_8
#elif DFG_MSVC_VER == DFG_MSVC_VER_2017_9
	#define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2017_9
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_0
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_0
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_1
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_1
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_2
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_2
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_3
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_3
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_4
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_4
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_5
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_5
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_6
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_6
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_7
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_7
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_8
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_8
#elif DFG_MSVC_VER == DFG_MSVC_VER_2019_9
    #define DFG_COMPILER_NAME_SIMPLE DFG_COMPILER_NAME_SIMPLE_VC2019_9
